...
const API_URL = import.meta.env.MODE === "development" ? "http://localhost:5000/api/auth" : "https://backend-inventory-system-mbhd8anur-castillawebs-projects.vercel.app/api/auth";
