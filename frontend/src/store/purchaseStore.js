...
const API_URL = import.meta.env.MODE === "development" ? "http://localhost:5000/api/purchases" : "https://backend-inventory-system-mbhd8anur-castillawebs-projects.vercel.app/api/purchases";
